...
const ProductDetailPage = () => {
  ...
  const [srcImg, setSrcImg] = useState(() => {
    if (!loadingGetProductDetail) return detail?.images?.[0]?.large_url;
  });
  useEffect(() => {
    if (!loadingGetProductDetail) setSrcImg(detail?.images?.[0]?.large_url);
  }, [detail]);
  ...
  const onAddWishList = useAction({
    ...
    errorMessage: (
      <p>
        <span className="font-semibold italic">"{`"${detail?.name}"`}"</span> đã
        được thêm vào danh sách yêu thích trước đó
      </p>
    ),
  });
        ...
        <div className="container">
          <div className="row">
            <div className="col-12">
              {!loadingGetProductDetail ? (
                <Breadcrumb>
                  <Breadcrumb.Item to={PATH.home}>Home</Breadcrumb.Item>
                  <Breadcrumb.Item to={categoryLink}>
                    {categoryItem?.title}
                  </Breadcrumb.Item>
                    ...
                    <div className="flickity-nav mx-n2 mb-10 mb-md-0 flex mt-5">
                      ...
                      {detail?.images?.length === 5 && (
                        <div
                          className="col-12 cursor-pointer px-2"
                          style={{ maxWidth: 113 }}
                          key={detail?.images?.[4]?.large_url}
                          onClick={() =>
                            setSrcImg(detail?.images?.[4]?.large_url)
                          }
                        >
                          <div
                            className="embed-responsive embed-responsive-1by1 bg-cover"
                            style={{
                              backgroundImage: `url(${detail?.images?.[4]?.large_url})`,
                            }}
                          ></div>
                        </div>
                      )}
                      {detail?.images?.length > 5 && (
                        ...
                        >
                          + {detail?.images?.length - 4} <br /> ảnh
                        </div>
                      )}
                    </div>
                    <ImagePreview ref={galleryRef} images={detail?.images} />
                  </div>
                        ...
                        <div className="form-row mb-7 items-baseline">
                          ...
                          <div className="col-12 col-lg">
                            ...
                            <Button
                              ...
                              loading={loadingUpdatecart[detail?.id]}
                            >
                              Add to Cart
                          ...
                          <div className="col-12 col-lg-auto">
                            ...
                            <Button
                              className="btn-block mb-2 normal-case"
                              outline
                              onClick={() => onAddWishList(detail?.id)}
                            >
